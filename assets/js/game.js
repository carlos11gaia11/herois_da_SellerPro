(() => {
  ...
  const heroData = [
    ...
    {name:'Carlos', img:ASSET_PATHS.heroes+'heroi7.png', icon:'☠️', color:'#06b6d4', desc:'Necromante tecnológico', hp:1000, dmg:50, speed:8.35, mana:240, manaRegen:1.05, hpRegen:.08, skills:[{name:'Laser', type:'laser', cost:24, cd:820},{name:'Drone', type:'drone', cost:46, cd:6200},{name:'Necromancia', type:'necromancy', cost:92, cd:9000},{name:'Coordenada', type:'coordinate', cost:58, cd:4600}]},
    ...
    {name:'Jose', img:ASSET_PATHS.heroes+'heroi9.png', icon:'🌪️', color:'#84cc16', desc:'ALA WAKIBAAA', hp:98, dmg:18, speed:5.05, mana:130, manaRegen:.6, hpRegen:.03, skills:[{name:'Rajada', type:'gust', cost:16, cd:450},{name:'Super Pulo', type:'highjump', cost:26, cd:2200}]},
  ...
  const secretHeroData = [
    {name:'Cronos Seller', secret:true, img:ASSET_PATHS.heroes+'heroi2.png', icon:'⏳', color:'#7dd3fc', desc:'Lendário do tempo', hp:820, dmg:72, speed:7.2, mana:520, manaRegen:2.4, hpRegen:.18, skills:[{name:'Congelar Tempo', type:'timeStop', cost:80, cd:8200},{name:'Voltar 5s', type:'rewind', cost:110, cd:12000},{name:'Cometa', type:'comet', cost:95, cd:5200},{name:'Invencível', type:'invincibility', cost:120, cd:15000}]},
    {name:'Nyx Invisível', secret:true, img:ASSET_PATHS.heroes+'heroi3.png', icon:'👁️', color:'#a78bfa', desc:'Assassina invisível', hp:620, dmg:86, speed:8.6, mana:430, manaRegen:2.1, hpRegen:.13, skills:[{name:'Invisibilidade', type:'invisibility', cost:58, cd:6500},{name:'Corte Samurai', type:'samurai', cost:55, cd:3100},{name:'Clone', type:'clone', cost:70, cd:7000},{name:'Bomba Sombra', type:'bomb', cost:72, cd:5200}]},
    {name:'Berserker Pro', secret:true, img:ASSET_PATHS.heroes+'heroi5.png', icon:'💢', color:'#ef4444', desc:'Fica absurdo com pouca vida', hp:1250, dmg:64, speed:6.6, mana:360, manaRegen:1.8, hpRegen:.1, passive:'berserker', skills:[{name:'Modo Berserker', type:'berserk', cost:60, cd:7600},{name:'Roubo Vital', type:'vampire', cost:62, cd:4200},{name:'Reviver', type:'revive', cost:120, cd:16000},{name:'Explodir Tela', type:'screenExplosion', cost:120, cd:9000}]},
    {name:'Singularidade', secret:true, img:ASSET_PATHS.heroes+'heroi4.png', icon:'🕳️', color:'#8b5cf6', desc:'Dobra o mapa inteiro', hp:700, dmg:78, speed:6.9, mana:560, manaRegen:2.6, hpRegen:.14, skills:[{name:'Buraco Negro', type:'blackhole', cost:90, cd:6800},{name:'Cometa do Céu', type:'cometRain', cost:115, cd:8500},{name:'Raio em Cadeia', type:'chainLightning', cost:72, cd:3700},{name:'Campo Zero', type:'timeStop', cost:95, cd:9000}]},
    {name:'Dragão Prime', secret:true, img:ASSET_PATHS.heroes+'heroi9.png', icon:'🐉', color:'#f97316', desc:'Vira dragão de guerra', hp:1080, dmg:82, speed:7.4, mana:470, manaRegen:2.2, hpRegen:.16, skills:[{name:'Virar Dragão', type:'dragon', cost:95, cd:12000},{name:'Chuva de Fogo', type:'cometRain', cost:105, cd:7800},{name:'Bomba', type:'bomb', cost:68, cd:4800},{name:'Invencível', type:'invincibility', cost:115, cd:14000}]},
    {name:'Arquiteto Final', secret:true, img:ASSET_PATHS.heroes+'heroi10.png', icon:'♾️', color:'#22c55e', desc:'Modo lendário criativo', hp:900, dmg:90, speed:8.1, mana:620, manaRegen:3.0, hpRegen:.2, skills:[{name:'Explodir Tudo', type:'screenExplosion', cost:120, cd:8200},{name:'Buraco Negro', type:'blackhole', cost:92, cd:6200},{name:'Coordenada', type:'coordinate', cost:62, cd:4300},{name:'Clone Supremo', type:'clone', cost:82, cd:6200}]}
  ];
  ...
  function spawnBoss(superBoss){
    ...
    const e = {
      ...
      x:LEVEL_WIDTH-820,y:FLOOR_Y-(superBoss?178:142),w:superBoss?188:150,h:superBoss?178:142,
      vx:0,vy:0,dir:-1,onGround:false,hp:superBoss?2450:1250,maxHp:superBoss?2450:1250,dmg:superBoss?38:26,speed:superBoss?1.05:1.25,
      shoot:true, projectile:superBoss?'dark':'fire', shootTimer:700, rate:superBoss?430:650, jump:true, flying:false, dash:true, frozen:0, hurt:0, points:superBoss?3000:1200,boss:true,superBoss,alive:true,aiTimer:0,bob:0,phase:1,summonTimer:superBoss?2600:3600,specialTimer:superBoss?1800:0,specialIndex:0,chargeTimer:0,speechTimer:0
    };
    enemies.push(e);
    audio.boss();
  }
  ...
  function moveEntity(ent, step){
    ...
    for(const p of platforms){
      if(p.type==='portal' || p.type==='spikes') continue;
